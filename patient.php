...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="time" class="form-control" name="admissiontime" id="admissiontime" placeholder="Enter admissiontime...." required="" value="<?php if(isset($_GET['editid'])) {echo $rsedit['admissiontime']; } ?>">
            <span class="messages"></span>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input class="form-control" type="date" name="dateofbirth" max="<?php echo date("Y-m-d"); ?>"
                        id="dateofbirth" value="<?php if(isset($_GET['editid'])) {echo $rsedit['dob']; } ?>" />
        </div>
    </div>
