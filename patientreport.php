    ...
    ?>
                    <div class="table-responsive dt-responsive">
                      ...
                      <tr>
                        ...
                        {
                          echo "<option value='$rsservice[service_type_id]'>$rsservice[service_type] (&nbsp;RM&nbsp;$rsservice[servicecharge])</option>";
                        }
                        ?>
                          </select>
                        </td>
        ...
        if($rs['bill_type']  == "Prescription charge")
        {
          ...
          echo " </td><td>&nbsp;RM $rs[bill_amount]</td></tr>";
                      ...
                      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                        <tbody>
                          <tr>
                            ...
                            <td>&nbsp;RM <?php echo $billamt; ?></td>
                          </tr>
                          <tr>
                            <th width="442" scope="col"><div align="right">Tax Amount (5%) &nbsp; </div></th>
                              <td width="95">&nbsp;RM <?php echo $taxamt = 5 * ($billamt / 100); ?>
                              </td>
                          </tr>

                      <tr>
                        <th scope="col"><div align="right">Discount &nbsp; </div></th>
                        <td>&nbsp;RM <?php echo $rsbilling_records['discount']; ?></td>
                        </tr>

                      <tr>
                        <th scope="col"><div align="right">Grand Total &nbsp; </div></th>
                        <td>&nbsp;RM <?php echo ($billamt + $taxamt)  - $rsbilling_records['discount'] ; ?></td>
                        </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  ?>
                    &nbsp;&#x20B9;. <?php echo $billamt; ?></td>
                          ...
                          <tr>
                            ...
                            <td width="413">&nbsp;</td>
                            <th width="442" scope="col"><div align="right">Tax Amount (5%) &nbsp; </div></th>
                            <td width="413">&nbsp;RM <?php echo $taxamt = 5 * ($billamt / 100); ?></td>
                          </tr>
                      ...
                      <tr>
                        ...
                        <th scope="col"><div align="right">Grand Total &nbsp; </div></th>
                        <td>&nbsp;RM <?php echo $grandtotal = ($billamt + $taxamt)  - $rsbilling_records['discount'] ; ?></td>
                        </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>RM <?php echo $balanceamt = $grandtotal - $rspayment[0]  ; ?></td>
                        </tr>
                        </tbody>
                      </table>
                      ...
                      ?>
                          ...
                          <?php
                              ...
                              ?>
                                   ...
                                   <td>&nbsp;RM <?php echo $rspayment['paidamount']; ?></td>
                                   </tr>
                              <?php
                              }
                          ?>
